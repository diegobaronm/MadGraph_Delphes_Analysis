...
void PartonAnalysis(const std::string& fileName, const std::string& outputFileName, bool doWeights = false){
    ...
    histograms.push_back(node.Histo1D({"Electron_1_pt_basic", "Electron_1_pt_basic", 30, 0, 300},"Electron_1_pt", weightColumn));
    histograms.push_back(node.Histo1D({"Electron_2_pt_basic", "Electron_2_pt_basic", 30, 0, 300},"Electron_2_pt", weightColumn));
    histograms.push_back(node.Histo1D({"Jet_1_pt_basic", "Jet_1_pt_basic", 100, 0, 1000},"Jet_1_pt", weightColumn));
    histograms.push_back(node.Histo1D({"Jet_2_pt_basic", "Jet_2_pt_basic", 100, 0, 1000},"Jet_2_pt", weightColumn)); 
    ...
    histograms.push_back(node.Histo1D({"mjj_basic", "mjj_basic", 50, 0, 5000},"mjj", weightColumn));
    histograms.push_back(node.Histo1D({"mll_basic", "mll_basic", 300, 0, 300},"mll", weightColumn));
    histograms.push_back(node.Histo1D({"dilepCentrality_basic", "dilepCentrality_basic", 100, 0, 1},"dilepCentrality", weightColumn));
    histograms.push_back(node.Histo1D({"dileptonPt_basic", "dileptonPt_basic", 50, 0, 1000},"dileptonPt", weightColumn));
...
void DelphesAnalysis(const std::string& fileName, const std::string& outputFileName, bool doWeights = false){
    ...
    histograms.push_back(node.Histo1D({"Electron_1_pt", "Electron_1_pt", 500, 0, 500},"Electron_1_pt", weightColumn));
    histograms.push_back(node.Histo1D({"Electron_2_pt", "Electron_2_pt", 500, 0, 500},"Electron_2_pt", weightColumn));
    histograms.push_back(node.Histo1D({"Jet_1_pt", "Jet_1_pt", 100, 0, 1000},"Jet_1_pt", weightColumn));
    histograms.push_back(node.Histo1D({"Jet_2_pt", "Jet_2_pt", 100, 0, 1000},"Jet_2_pt", weightColumn));   
    histograms.push_back(node.Histo1D({"deltaPhi_electrons", "deltaPhi_electrons", 64, 0, 3.2},"deltaPhi_electrons", weightColumn));
    histograms.push_back(node.Histo1D({"deltaRapidity", "deltaRapidity", 100, 0, 10},"deltaRapidity", weightColumn));
    histograms.push_back(node.Histo1D({"mjj", "mjj", 50, 0, 5000},"mjj", weightColumn));
    histograms.push_back(node.Histo1D({"mll", "mll", 300, 0, 300},"mll", weightColumn));
    ...
    histograms.push_back(node.Histo1D({"dileptonPt", "dileptonPt", 100, 0, 1000},"dileptonPt", weightColumn));
...
void DelphesAnalysisTau(const std::string& fileName, const std::string& outputFileName, bool doWeights = false){
    ...
    histograms.push_back(node.Histo1D({"topology_basic", "topology_basic", 4, 0, 4},"topology", weightColumn));
...
void Analysis(){
    //PartonAnalysis("DATA/NO_EWKDiagrams.root", "PartonLevel_NO_EWKDiagramsWeighted.root", true);
    DelphesAnalysisTau("DATA/Zp_plus_SM_Delphes.root", "Zp_plus_SM_Weighted.root", true);
}
